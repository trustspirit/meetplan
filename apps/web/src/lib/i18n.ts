...
const ko = {
  ...
  'fields.sectionTitle': '응답자에게 받을 정보',
  'fields.always': '항상 수집',
  'fields.name': '이름',
  'fields.note': '기타 사항',
  'fields.phone': '전화번호',
  'fields.phoneOn': '받음',
  'fields.phoneOff': '안 받음',
  'fields.labelPlaceholder': '예: 소속',
  'fields.labelAria': '항목 이름',
  'fields.required': '필수',
  'fields.remove': '항목 삭제',
  'fields.add': '+ 항목 추가',
  'fields.count': '{count}/{max}',
  'fields.labelMissing': '항목 이름을 입력해주세요',
  'period.suffix': '분',
  'period.custom': '직접 입력',
...
const en: TranslationMap = {
  ...
  'fields.sectionTitle': 'Information to collect',
  'fields.always': 'Always',
  'fields.name': 'Name',
  'fields.note': 'Notes',
  'fields.phone': 'Phone number',
  'fields.phoneOn': 'Collect',
  'fields.phoneOff': "Don't collect",
  'fields.labelPlaceholder': 'e.g. Team',
  'fields.labelAria': 'Field name',
  'fields.required': 'Required',
  'fields.remove': 'Remove field',
  'fields.add': '+ Add field',
  'fields.count': '{count}/{max}',
  'fields.labelMissing': 'Please name this field',
  'period.suffix': ' min',
